...
**CSE0001 — Digital Literacy | Task 5 | VIT Bhopal University**
...
2. **Never enter your UPI PIN to 'receive' money** — Collecting a payment requires NO PIN. If you are asked to enter your PIN to receive a refund or prize, it is a scam. Hang up immediately.
...
5. **Use strong, unique passwords** for all accounts. Avoid using the same password across multiple platforms — especially for banking and email.
